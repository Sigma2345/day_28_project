from tkinter import * #import all files
# ---------------------------- CONSTANTS ------------------------------- #
PINK = "#e2979c"
RED = "#e7305b"
GREEN = "#9bdeac"
...
def start_timer():
    ...
    if reps%8 == 0 :
        title_label.config(text="LONG BREAK", fg=RED, bg=YELLOW, font=(FONT_NAME, 50))
...
timer_text = canvas.create_text(100, 130,text="00:00" , fill="white", font=(YELLOW, 35, "bold"))
...
reset_button = Button(text="Reset", highlightthickness=0, command=restart_timer)
